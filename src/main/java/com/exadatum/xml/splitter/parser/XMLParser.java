...
import com.exadatum.xml.splitter.utils.TempFileGenerator;
import com.exadatum.xml.splitter.processors.WorkScheduleProcessor;
import com.exadatum.xml.splitter.processors.WorkTimeProcessor;
...
public class XMLParser {
    ...
    public static <T> void WriteToFile(List<T> recordSet, String OutDir, String outFileName) throws IOException {
        ...
        for (T itr : recordSet) {
            ...
            String[] resArr = itr.toString().split(Constants.FIELD_SEPERATOR);
