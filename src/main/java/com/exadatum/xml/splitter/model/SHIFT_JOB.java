...
public class SHIFT_JOB {
    ...
    private String SegmentStartTs;
    private String ShiftJob_id;
    private String ShiftJobCd;
    private String SegmentId;
    private String SegmentEndTs;
    private String ShiftJobTitleNm;
    ...
    public String getSegmentStartTs() {
        return SegmentStartTs;
    }

    public void setSegmentStartTs(String segmentStartTs) {
        SegmentStartTs = segmentStartTs;
    }

    public String getShiftJob_id() {
        return ShiftJob_id;
    }

    public void setShiftJob_id(String shiftJob_id) {
        ShiftJob_id = shiftJob_id;
    }

    public String getShiftJobCd() {
        return ShiftJobCd;
    }

    public void setShiftJobCd(String shiftJobCd) {
        ShiftJobCd = shiftJobCd;
    }
    ...
    public String getSegmentEndTs() {
        return SegmentEndTs;
    }

    public void setSegmentEndTs(String segmentEndTs) {
        SegmentEndTs = segmentEndTs;
    }

    public String getShiftJobTitleNm() {
        return ShiftJobTitleNm;
    }

    public void setShiftJobTitleNm(String shiftJobTitleNm) {
        ShiftJobTitleNm = shiftJobTitleNm;
    }
