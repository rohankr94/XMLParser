...
if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='JobTitle']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='JobTitle']) )
else ("") ,
...
if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='HourTypeId']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='HourTypeId']) )
else ("") ,

if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='HourTypeDsc']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='HourTypeDsc']) )
else ("") ,

if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='TimeCodeId']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='TimeCodeId']) )
else ("") ,

if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='TimeCodeDsc']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='TimeCodeDsc']) )
else ("") ,

if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='ProjectId']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='ProjectId']) )
else ("") ,

if (exists($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='ProjectDsc']))
then
( data($doc/GetEmployeeWorkTime/WorkTimeData/WorkTime//*[local-name()='ProjectDsc']) )
else ("") ,
